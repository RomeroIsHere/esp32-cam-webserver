...
#define CAM_NAME "ESP32 Face Recognition Server"
...
struct station stationList[] = {{"ESP-CAM face-net","", true}};
...
#define DEFAULT_RESOLUTION FRAMESIZE_CIF
...
// Assume the module used has SD_MMC partition, and use that for persistent setting storage
...
#define GOOD_FACE_TEXT "Cara #"
#define BAD_FACE_TEXT "Cara Desconocida"
